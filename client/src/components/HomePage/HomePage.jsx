      ...
      <main>
        <div className="main-container">
          ...
          <div className="barra__right">
            ...
            <div className="navegacion">
              {/* Ropa */}
              <a className="navegacion_enlace">Ropa</a>
              {/* Calzados */}
              <a className="navegacion_enlace">Calzados</a>
              {/* Accesorios */}
              <a className="navegacion_enlace">Accesorios</a>
              {/* Marcas */}
              <a className="navegacion_enlace">Marcas</a>
            </div>
          </div>
