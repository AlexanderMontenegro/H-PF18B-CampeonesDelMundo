...
const {  DATABASE_UR, DB_USER_L, DB_PASSWORD_L, DB_HOST_L, DB_PORT_L, DB_NAME_L } = process.env;

const sequelize = new Sequelize(
   `postgres://${DB_USER_L}:${DB_PASSWORD_L}@${DB_HOST_L}@${DB_PORT_L}@${DB_NAME_L}/campeones`,
   {
